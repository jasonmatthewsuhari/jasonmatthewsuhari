...
## <img src="https://media.giphy.com/media/hvRJCLFzcasrR4ia7z/giphy.gif" width="28"> &nbsp;소개

인도네시아 출신으로 현재 싱가포르에 거주하는 데이터 사이언티스트이자 인디 게임 개발자 지망생입니다. 프로 에어컨 애호가, 소규모 푸드 크리틱, 픽셀 아트 애호가입니다. 여가 시간에는 다양한 요리를 만들고, 해커톤에 참가하고, 블로그를 작성합니다.

프로필 사진 때문에 잠자면서 MLM 3개를 운영하는 것처럼 보이지만, 사람들과 이야기하고 새로운 친구를 사귀는 걸 좋아합니다 :)
...
## <img src="https://media.giphy.com/media/iY8CRBdQXODJSCERIr/giphy.gif" width="28"> &nbsp;주요 프로젝트
...
## <img src="https://media.giphy.com/media/W5eoZHPpUx9sapR0eu/giphy.gif" width="28"> &nbsp;GitHub 분석
